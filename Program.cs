    ...
    class Program
    {
        static void Main(string[] args)
        {
            var commands = new Dictionary<string, string>
            {
                ...
                ["Checking for Unquoted Service Path"] = "gwmi -class Win32_Service -Property Name, DisplayName, PathName, StartMode | Where {$_.StartMode -eq \"Auto\" -and $_.PathName -notlike \"C:\\Windows*\" -and $_.PathName -notlike '\"*'} | select PathName,DisplayName,Name",
